...
{
    public abstract class DevExpViewerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DevExpViewerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DevExpViewerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DevExpViewerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DevExpViewerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DevExpViewerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DevExpViewerDbContext, Task<T>> func)
        {
            T result;
